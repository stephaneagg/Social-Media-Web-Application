...
public class GlobalExceptionHandler {
    ...
    // Handle FollowException
    @ExceptionHandler(FollowException.class)
    public ResponseEntity<ErrorDetails> handleFollowException(FollowException exception, WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
                exception.getMessage(),
                webRequest.getDescription(false),
    ...
    public ResponseEntity<ErrorDetails> handleValidationException(HandlerMethodValidationException exception, WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
                exception.getMessage(),
                webRequest.getDescription(false),
